<table id="tb_index_clients" class="table table-bordered table-striped">
    <thead>
    <tr>
        <th>
            ID
    ...
    @foreach($clients as $item)
        <tr data-id="{{ 'tr_client_'.$item->id }}">
            ...
            <td>
                <a title="@lang('common.table_title_edit')" href="{{ url('clients/'.$item->id.'/edit') }}" class="btn btn-primary btn-xs">
