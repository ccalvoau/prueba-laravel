    ...
    <div class="col-md-12">
        ...
        <div class="box box-solid box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Create a new Cleaner</h3>
            </div><!-- /.box-header -->
            ...
            <div class="box-body">
                ...
                {!! Form::open(['url' => 'cleaners', 'class' => 'form-horizontal']) !!}
                {!! Form::token() !!}

                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('document_id') ? 'has-error' : ''}}">
                        {!! Form::label('document_id', '* Type Id: ', ['class' => 'col-sm-4 control-label']) !!}
                        <div class="col-sm-6">
                            {!! Form::select('document_id', $documents, '', ['class' => 'form-control select2', 'required' => '']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group {{ $errors->has('gender') ? 'has-error' : ''}}">
                        ...
                        <div class="col-sm-6">
                            {!! Form::select('gender', ['F' => 'FEMALE', 'M' => 'MALE', '' => 'SELECT AN OPTION'], '', ['class' => 'form-control select2', 'required' => '']) !!}
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group" {{ $errors->has('tfn') ? 'has-error' : ''}}>
                        ...
                        <div class="col-sm-6">
                            <label>
                                {!! Form::radio('own_vehicle', 'true', false, ['class' => 'minimal', 'onmouseover' => 'this.focus();']) !!}
                                YES
                            </label>
                            &nbsp;&nbsp;&nbsp;
                            <label>
                                {!! Form::radio('own_vehicle', 'false', true, ['class' => 'minimal', 'onmouseover' => 'this.focus();']) !!}
                                NO
                            </label>
                        </div>
                    </div>
