...
<div class="col-md-6">
    <div class="form-group {{ $errors->has('leader') ? 'has-error' : ''}}">
        ...
        <div class="col-sm-6">
            ...
            !!}
            {!! Form::hidden('h_leader', $team->leader, [
                'id' => 'h_leader'
                ])
            !!}
            {!! Form::hidden('h_cleaner_id2', $team->cleaner_id2, [
                'id' => 'h_cleaner_id2'
                ])
            !!}
            {!! Form::hidden('h_cleaner_id3', $team->cleaner_id3, [
                'id' => 'h_cleaner_id3'
                ])
            !!}
            {!! Form::hidden('h_cleaner_id4', $team->cleaner_id4, [
                'id' => 'h_cleaner_id4'
                ])
            !!}
            {!! Form::hidden('h_cleaner_id5', $team->cleaner_id5, [
                'id' => 'h_cleaner_id5'
                ])
            !!}
            {!! Form::hidden('h_cleaner_id6', $team->cleaner_id6, [
                'id' => 'h_cleaner_id6'
                ])
            !!}
        </div>
...
<div class="col-md-6">
    <div class="form-group {{ $errors->has('status') ? 'has-error' : ''}}">
        {!! Form::label('status', '* '.Lang::get('validation.attributes.team.status').':', ['class' => 'col-sm-4 control-label']) !!}
        <div class="col-sm-6">
            {!! Form::select('status', [
