                ...
                <section class="content">
                    ...
                    <div class="box box-solid box-primary">
                        ...
                        <div class="box-header with-border">
                            <div class="box-title">
                                @lang('validation.attributes.team.edit_title_table'): {{ $team->id }}
                            </div>
                            <div class="pull-right">
                                <a href="{{ route('teams::show', [$team->id]) }}" class="btn btn-default btn-xs">
                                    <i class="fa fa-search"></i>
                                    @lang('validation.attributes.team.button_show')
                                </a>
                                &nbsp;
                        ...
                        <div class="box-body">
                            ...
                            {!! Form::model($team, ['route' => ['teams::update', $id], 'class' => 'form-horizontal', 'method' => 'put']) !!}

                                @include('teams.partials.fields_edit')

                                <div class="col-md-12">
                                    <hr>
                                    <button type="submit" class="btn btn-block btn-primary">
                                        @lang('validation.attributes.team.button_update')
                                    </button>
                                </div><!-- /.col12 -->
